System.register(["@beyond-js/widgets@0.1.4/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.0.0/base", "react@18.2.0"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets014Render) {
      ...
      dependency_3 = _beyondJsReact18Widgets100Base;
    }, function (_react) {
      dependency_4 = _react;
    }],
    execute: function () {
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@beyond-js/reactive@1.0.1/reactive-layout');
      ims = new Map();
      /****************************
